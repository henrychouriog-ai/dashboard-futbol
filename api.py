...
def _api_get(endpoint, params=None):
    try:
        ...
        # Agregamos un timestamp para forzar a la API a no usar cache
...
@st.cache_data(ttl=300) # Solo guarda memoria por 5 minutos
def obtener_ligas():
...
def obtener_h2h(id_local, id_visitante):
    # Buscamos sin filtros para asegurar que traiga algo
